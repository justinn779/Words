...
export const SEED: SeedRow[] = [
  ...
  { categoryId: 'protein', name: '高蛋白食物', words: ['雞胸肉', '鮭魚', '豆腐', '雞蛋', '黑豆', '毛豆', '鷹嘴豆', '蝦仁', '起司', '牛肉'] },
  { categoryId: 'koreanFood', name: '韓式料理', words: ['泡菜', '拌飯', '部隊鍋', '炸醬麵', '冷麵', '烤肉', '紫菜飯捲', '辣炒年糕', '雪濃湯', '炸雞'] },
  { categoryId: 'zodiac', name: '星座', words: ['牡羊座', '金牛座', '雙子座', '巨蟹座', '獅子座', '處女座', '天秤座', '天蠍座', '射手座', '水瓶座'] },
]
